...
Usage:
    python3 -m wisent_release baseline            # rewrite released-surface.json
    python3 -m wisent_release baseline --print    # write nothing, show what it would produce
"""
...
def main(argv: list) -> int:
    ...
    document = {
        ...
        "source": (
            ...
            f"wisent_release/{EXTRACTOR}; regenerate with python3 -m wisent_release baseline"
        ),
        "surface": names,
    }
