...
class SVGAreaChart2Patterns:
    ...
    def _create_patterns(self, svg):
        ...
        _load_pattern_from_file(
            defs, 'pattern-bottom', _asset_path('pattern_vertical_lines.svg')
        )
        _load_pattern_from_file(
            defs, 'pattern-middle', _asset_path('pattern_diagonal_lines.svg')
        )
        _load_pattern_from_file(
            defs, 'pattern-top', _asset_path('large', 'dither_cross_large.svg')
        )
