...
class SVGAreaChartGradient:
    ...
    def create_chart(
        ...
        chart_start_y = render_title_and_legend(
            ...
            fills=["url(#grad-bottom)", "url(#grad-middle)", "url(#grad-top)"],
    ...
    def _create_gradients(self, svg, chart_start_y):
        ...
        ET.SubElement(
            grad1,
            "stop",
            {"offset": "0%", "style": "stop-color:#C5FFC8;stop-opacity:1"},  # Light at bottom
        )
        ET.SubElement(
            grad1,
            "stop",
            {"offset": "100%", "style": "stop-color:#7FA682;stop-opacity:1"},  # Darker at top
        )
        ...
        grad2 = ET.SubElement(
            defs,
            "linearGradient",
            {"id": "grad-middle", "x1": "0%", "y1": "100%", "x2": "0%", "y2": "0%"},
        )
        ET.SubElement(grad2, "stop", {"offset": "0%", "style": "stop-color:#90B892;stop-opacity:1"})
        ET.SubElement(
            grad2, "stop", {"offset": "100%", "style": "stop-color:#5F7861;stop-opacity:1"}
        )
        ...
        grad3 = ET.SubElement(
            defs,
            "linearGradient",
            {"id": "grad-top", "x1": "0%", "y1": "100%", "x2": "0%", "y2": "0%"},
        )
        ET.SubElement(grad3, "stop", {"offset": "0%", "style": "stop-color:#5A715B;stop-opacity:1"})
        ET.SubElement(
            grad3, "stop", {"offset": "100%", "style": "stop-color:#3D4D3E;stop-opacity:1"}
        )
