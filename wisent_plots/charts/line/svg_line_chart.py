...
from wisent_plots.charts.svg_components import render_marker, render_title_and_legend
...
class SVGLineChart:
    ...
    def create_chart(
        ...
        self._render_lines(
            svg, x_data, y_series, chart_x, chart_start_y, line_width, show_markers, marker_shapes
        )
        ...
        for series_idx, series_data in enumerate(y_series):
            ...
            if show_markers:
                for x_pos, y_pos in points:
                    render_marker(svg, x_pos, y_pos, marker_shape, color)
